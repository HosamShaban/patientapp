...
import 'package:patientapp/features/auth/login/presentation/view/signin_screen.dart';
            ...
            child: PageView(
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset(DefaultImages.onBoarding1),
                      Container(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset(DefaultImages.onBoarding3),
                      Container(
                        padding: const EdgeInsets.all(10),
                        child: const Text(
                          'متابعة نسبة السكر',
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Image.asset(DefaultImages.onBoarding2),
                      Container(
                        padding: const EdgeInsets.all(10),
                        child: const Text(
                          'عزيزي المريض',
